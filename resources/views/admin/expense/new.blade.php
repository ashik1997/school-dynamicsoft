		        	...
		        	<div class="row">
		        	  <div class="col-md-6">
		                <div class="form-group">
		                  ...
		                  <input type="text" name="purpose" id="purpose" class="form-control" value="{{old('purpose')}}" placeholder="খরচের উদ্দেশ্য" required autofocus="true">
		                </div>
		              </div>
		              <div class="col-md-6">
		                <div class="form-group">
		                  <label for="amount">খরচের পরিমাণ</label>
		                  <input type="text" name="amount" id="amount" class="form-control" value="{{old('amount')}}" placeholder="খরচের পরিমাণ" required>
		                </div>
		              </div>
		        	  <div class="col-md-6">
		                <div class="form-group">
		                  <label for="date">খরচের তারিখ</label>
		                  <input type="date" name="date" id="date" value="{{old('amount')}}" class="form-control" placeholder="খরচের তারিখ" required>
		                </div>
		              </div>
		              <!-- /.col -->
		        	</div>

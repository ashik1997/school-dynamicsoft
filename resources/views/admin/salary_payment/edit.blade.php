...
@section('title', 'শিক্ষক-কর্মচারী বেতন সম্পাদনা করুন ')
@section('link')
<!-- vue -->
...
<div class="content-header">
	<div class="container-fluid">
	    <div class="row mb-2">
	      <div class="col-sm-6">
	        <h1 class="m-0 text-dark">শিক্ষক-কর্মচারী বেতন সম্পাদনা</h1>
	      </div><!-- /.col -->
	      <div class="col-sm-6">
	        <ol class="breadcrumb float-sm-right">
	          <li class="breadcrumb-item"><a href="{{route('dashboard')}}">হোমে</a></li>
	          <li class="breadcrumb-item"><a href="{{route('salary-payment-list')}}">শিক্ষক-কর্মচারী বেতন</a></li>
...
<section class="content">
	...
	<div class="row">
	  	<div class="col-md-8">
		    <form action="{{ route('salary-payment-edit',$salary_payment->id) }}" method="post" enctype="multipart/form-data">
		    	@csrf
		        	...
		        	<div class="row">
		              <div class="col-md-6">
		                <div class="form-group">
		                	<input type="hidden" name="payment_id" value="{{$salary_payment->id}}">
		              ...
		              <div class="col-md-6">
		                <div class="form-group">
		                  ...
		                  <input type="date" v-model="paid_date" name="paid_date" id="paid_date" class="form-control" value="{{old('paid_date')}}">
		                </div>
		              </div>
		              <!-- /.col -->
		        	</div>
...
<script>
	var app = new Vue({
	    el: "#app",
	    data: {
	    	employee_id : "{{$salary_payment->employee_id}}",
	    	amount: "{{$salary_payment->amount}}",
	    	paid_date: "{{$salary_payment->date}}",
	    	month: "{{$salary_payment->month}}",
	    	year: "{{$salary_payment->year}}",
	    	img: "",
	    	name: '',
	    	id: '',
	    	phone: '',

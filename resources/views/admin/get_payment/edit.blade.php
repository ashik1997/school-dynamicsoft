...
@section('title', 'গেট পেমেন্ট সম্পাদনা')
@section('link')
<!-- vue -->
...
<section class="content">
	...
	<div class="row">
	  	<div class="col-md-8">
		    <form action="{{ route('get-payment-edit',$get_payment->id) }}" method="post" enctype="multipart/form-data">
		    	@csrf
		      <div class="card card-primary">
		        <div class="card-header">
		          <h3 class="card-title">গেট পেমেন্ট সম্পাদনা</h3>
...
var app = new Vue({
    el: "#app",
    data: {
    	student_id : "{{$get_payment->student_id}}",
    	waiver_amount: "{{$get_payment->waiver_amount}}",
    	img: '',
    	name: '',
    	id: '',
    	phone: '',
    	position: '',
    	note: "{{$get_payment->note}}",
    	paid_amount: "{{$get_payment->paid_amount}}",
    	get_date: "{{$get_payment->get_date}}",
    	classes: {!!json_encode($classes)!!},

    	year: "{{$get_payment->set_payment->year}}",
    	class_id: "{{$get_payment->set_payment->class_id}}",
    	fees: '',
    	set_payment_id : "{{$get_payment->set_payment_id}}",
    },
    methods: {
        getStuInfo: function(){

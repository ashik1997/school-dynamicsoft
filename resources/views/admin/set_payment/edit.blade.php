...
@section('title', 'সেট পেমেন্ট সম্পাদনা')
@section('link')
<!-- vue -->
...
<section class="content">
	...
	<div class="row">
	    <div class="col-md-6">
		    <form action="{{ route('set-payment-edit',$set_payment->id) }}" method="post" enctype="multipart/form-data">
	    	@csrf
		      <div class="card card-primary">
		        	...
		        	<div class="row">
		        	  <div class="col-md-6">
		                <div class="form-group">
		                  ...
		                  <input type="text" name="purpose" id="purpose" class="form-control" value="{{$set_payment->purpose}}" placeholder="পেমেন্ট উদ্দেশ্য" required autofocus="true">
		                </div>
		              </div>
		              <div class="col-md-6">
		                <div class="form-group">
		                  <label for="amount">পরিমাণ</label>
		                  <input type="text" name="amount" id="amount" class="form-control" value="{{$set_payment->amount}}" placeholder="পেমেন্ট পরিমাণ" required>
		                </div>
		              </div>
		              <div class="col-md-6">
						<div class="form-group">
							<label for="year">সাল</label>
							<select v-model='year' name="year" id="year" class="form-control" ></select>
						</div>
		              </div>
		        	  <div class="col-md-6">
		                <div class="form-group">
		        ...
		        <div class="card-footer">
		        	<input type="submit" class="btn btn-success btn-lg float-right" value="আপডেট">
		    	</div>
		      </div>
		      <!-- /.card -->
		     </form>
...
<script>
	var app = new Vue({
	    ...
	    data: {
	    	...
	    	class_id: "{{$set_payment->class_id}}",
	    	year: "{{$set_payment->year}}",
	    },
	    methods: {

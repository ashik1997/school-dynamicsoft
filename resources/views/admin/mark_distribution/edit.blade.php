...
@section('title', 'নতুন মার্ক ডিস্ট্রিবিউশন সম্পাদনা করুন ')
@section('link')
<!-- vue -->
...
<section class="content">
    ...
    @endif
    <form action="{{ route('mark-distribution-edit',$subjects->id) }}" method="post" enctype="multipart/form-data">
    	@csrf
	  <div class="row">
	    <div class="col-md-7">
	        	...
	        	<div class="row" v-for="(row,k) in rows" :key="k">
	        	   <div class="col-md-6">
					<div class="form-group">
						...
						<input type="hidden" name="md_id[]" id="md_id" :value="row.id">
						<input type="text" name="name[]" id="name" class="form-control" :value="row.name" placeholder="নাম">
					</div>
	              </div>
	              <div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" name="mark[]" id="mark" class="form-control" :value="row.mark" placeholder="মার্ক">
...
<script>
	var app = new Vue({
	    el: "#app",
	    data: {
	        rows: {!!json_encode($subjects->mark_distributions)!!},
            classes: '',
            subjects: "",
            class_id: "{{$subjects->cls->id}}",

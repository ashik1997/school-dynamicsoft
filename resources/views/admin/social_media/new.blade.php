      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
        	<div class="card-header">
	            <h3 class="card-title">Add New Social Media</h3>
        	</div>
        	<!-- /.card-header -->
        	@if ($errors->any())
            ...
            @endif
	        <form action="{{ route('social-media-add') }}" method="post" enctype="multipart/form-data">
	        	@csrf
		        <div class="card-body">
		        	<div class="row">
		              <div class="col-md-6">
		              ...
		              <div class="col-md-6">
		                <div class="form-group">
		                  ...
		                  <input type="url" name="url" id="url" class="form-control" value="" placeholder="Enter url">
		                </div>
		              </div>
		              <div class="col-md-6">
		                <div class="form-group">
		                  <label for="icon">Icon</label>
		                  <input type="text" name="icon" id="icon" class="form-control" value="" placeholder="Enter icon">
		                </div>
		              </div>
		              <!-- /.col -->
		        	</div>

		        	...
		        	<div class="row">
		              <div class="col-md-12">
		                <div class="form-group">
		                  ...
		                  <input type="text" name="title" id="title" class="form-control" value="{{$blog->title}}" placeholder="Enter title">
		                </div>
		              </div>
		              <div class="col-md-12">
		                <div class="form-group">
		                  <label for="sub_title">Sub-title</label>
		                  <input type="text" name="sub_title" id="sub_title" class="form-control" value="{{$blog->sub_title}}" placeholder="Enter sub-title">
		                </div>
		              </div>
		              <div class="col-md-6">
		                <div class="form-group">
		                  <label>Banner (Dimensions: 849x450)</label>
		                  <input type="file" name="image" id="image" class="form-control-file" >
		                  <br>
		                  <img src="{{asset('frontend/')}}/assets/img/blog/{{ $blog->image }}" height="150" width="283" alt="">
		                </div>
		                <!-- /.form-group -->
		              </div>
		              <!-- /.col -->
